...
const CardProject: React.FC<ProjectCardProps> = ({
  ...
  return (
    <section>
      <div className="sm:flex gap-5 mb-10 sm:px-0 px-5 h-64">
        ...
        <div className="flex flex-col self-baseline">
          <div>
            <h3 className="font-bold text-3xl text-slate-600 dark:text-white">
              {title}
            </h3>
          </div>
          <div>
          ...
          <div>
            <a href={urlButton} target="_blank">
              <button className="flex p-2 mt-3 w-auto text-white dark:text-black font-bold dark:font-bold bg-slate-800 dark:bg-white rounded-md transition-all gap-2 hover:gap-5">
                <div>Code</div>
                <div>
                  <svg
                    viewBox="0 0 24 24"
